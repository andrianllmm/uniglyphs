...
export const TOOLBAR_OFFSET = 30;
...
export function getToolbarPos(
  ...
  if (!coords || (coords.left === 0 && coords.top === 0)) {
    return getAlignToolbarPos(toolbar, fallback_alignment);
  }

  const textboxRect = textbox.getBoundingClientRect();

  let newTop = textboxRect.top + coords.top + window.scrollY + TOOLBAR_OFFSET;
